...
function setSize(){
    canv.style.height = (window.scrollY +document.getElementById("title_section").getBoundingClientRect().bottom)+"px";
    canv.width = canv.clientWidth-1;
    canv.height = canv.clientHeight-1;
}
setSize()
